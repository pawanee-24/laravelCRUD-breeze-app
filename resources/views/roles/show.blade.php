<x-app-layout>
    ...
    {{-- Page heading --}}
    <x-slot name="pageTitle">Role Details</x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('roles.edit', $roles->id) }}" class="btn btn-sm btn-warning p-2 text-dark">Edit Role -<i class="fa fa-angle-right"></i></a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">{{ $roles->id }}</div>
                    </div>

                    <div class="row mb-3">
                        <div class="col-md-3 font-weight-bold">Name:</div>
                        <div class="col-md-9">{{ $roles->name }}</div>
                    </div>

                    <div class="row mb-3">
                        <div class="col-md-3 font-weight-bold">Description:</div>
                        <div class="col-md-9">{{ $roles->description ?? 'N/A' }}</div>
                    </div>

                    <div class="row mb-3">
                        <div class="col-md-3 font-weight-bold">Created At:</div>
                        <div class="col-md-9">{{ $roles->created_at->format('Y-m-d H:i') }}</div>
                    </div>

                    <div class="row mb-3">
                        <div class="col-md-3 font-weight-bold">Updated At:</div>
                        <div class="col-md-9">{{ $roles->updated_at->format('Y-m-d H:i') }}</div>
                    </div>
                </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @if($roles->permissions->count())
                        ...
                        @endforeach
                    @else
                        <span class="text-danger">No permissions assigned</span>
                    @endif
                </div>
            ...
            <div class="mt-3 d-flex justify-content-end">
                <a href="{{ route('roles.index') }}" class="btn btn-sm btn-secondary p-2">
